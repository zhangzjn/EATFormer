...
def save_checkpoint(state, is_best, log_dir='.', prefix='train'):
	save_path = f'{log_dir}/{prefix}_model.pth'
	torch.save(state, save_path)
	shutil.copyfile(save_path, f'{log_dir}/best_model.pth') if is_best else None
	torch.save(state['net'], f'{log_dir}/net_{os.path.basename(log_dir)}.pth') if is_best else None
