...
def crossformer_tiny(pretrained=False, **kwargs):
	model = CrossFormer(
...
@MODEL.register_module
def crossformer_small(pretrained=False, **kwargs):
	model = CrossFormer(
		img_size=224, patch_size=[4, 8, 16, 32], in_chans=3,
		embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24],
		group_size=[7, 7, 7, 7], mlp_ratio=4., qkv_bias=True, qk_scale=None,
...
@MODEL.register_module
def crossformer_base(pretrained=False, **kwargs):
	model = CrossFormer(
		img_size=224, patch_size=[4, 8, 16, 32], in_chans=3,
...
@MODEL.register_module
def crossformer_large(pretrained=False, **kwargs):
	model = CrossFormer(
		img_size=224, patch_size=[4, 8, 16, 32], in_chans=3,
